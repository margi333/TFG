...
namespace _3_Curs_C__i_mySQL
{
    ...
    public partial class Form1 : Form
    {
        ...
        // Aquest mètode es desencadena quan l'usuari fa clic al botó de cerca.
        // La seva funció és buscar un producte a la base de dades a partir del codi introduït.
        private void button1_Click(object sender, EventArgs e)
        {
            // S'obté el codi del producte des del control de text.
            string codigo = txtCodigo.Text;
            MySqlDataReader reader = null;

            // Es crea la consulta SQL per cercar el producte per ID. (*Nota: Vulnerable a injecció SQL*)
            ...
            {
                // Gestió d'errors en la connexió o execució SQL.
                MessageBox.Show("Error al buscar: " + ex.Message);
            }
            finally
            {
                // Es tanca la connexió amb la base de dades.
                conexionBD.Close();
            }
        }
        ...
        // Aquest mètode permet inserir un nou producte a la base de dades.
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                // Conversió i validació dels valors introduïts.
            ...
            {
                // Si el format és incorrecte, es mostra un missatge d'error.
                MessageBox.Show("Error: " + ex.Message);
                Limpiar();
                return;
            }

            // Validació de camps obligatoris abans de guardar.
            if (nombre != "" && descripcion != "" && precio_publico > 0 && existencias > 0)
            {
                // Consulta SQL per inserir un nou registre. (*Nota: Vulnerable a injecció SQL*)
        ...
        // Aquest mètode permet actualitzar un producte ja existent a la base de dades.
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            if (nombre != "" && descripcion != "" && precio_publico > 0 && existencias > 0)
            {
                // Consulta SQL per modificar un producte existent. (*Nota: Vulnerable a injecció SQL*)
        ...
        // Aquest mètode elimina un producte de la base de dades en funció del seu ID.
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            string id = txtCodigo.Text;

            // Consulta SQL per eliminar el registre. (*Nota: Vulnerable a injecció SQL*)
        ...
        // Aquest mètode es crida quan l'usuari vol esborrar tots els camps del formulari.
        private void btnLimpiar_Click(object sender, EventArgs e)
        {
            Limpiar();
        }

        // Funció auxiliar per buidar tots els controls de text del formulari.
