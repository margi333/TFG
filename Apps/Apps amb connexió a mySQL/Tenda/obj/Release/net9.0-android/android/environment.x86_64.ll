...
@aot_dso_cache = dso_local local_unnamed_addr global [1125 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x278fdd07ca8dc59c, ; from name: libaot-Tenda.dll.so
		i64 u0x278fdd07ca8dc59c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Tenda.dll.so
		ptr null; void* handle
	}, ; 178
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x3ee993c972097a0b, ; from name: libaot-Tenda
		i64 u0x278fdd07ca8dc59c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Tenda.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x57c64100f5619d2c, ; from name: libaot-Tenda.so
		i64 u0x278fdd07ca8dc59c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Tenda.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x599d17d1f9cbc632, ; from name: aot-Tenda.so
		i64 u0x278fdd07ca8dc59c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Tenda.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xa344968cf2b0ad70, ; from name: aot-Tenda.dll.so
		i64 u0x278fdd07ca8dc59c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Tenda.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xa8f602c7b30c1e13, ; from name: Tenda.so
		i64 u0x278fdd07ca8dc59c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Tenda.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xa956044ab238d2fa, ; from name: aot-Tenda
		i64 u0x278fdd07ca8dc59c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Tenda.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xbe1bb07996b07bed, ; from name: Tenda
		i64 u0x278fdd07ca8dc59c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Tenda.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe9ec72cf038238a8, ; from name: Tenda.dll.so
		i64 u0x278fdd07ca8dc59c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Tenda.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [22 x i8] c"com.companyname.tenda\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [20 x i8] c"libaot-Tenda.dll.so\00", align 16
