...
@aot_dso_cache = dso_local local_unnamed_addr global [756 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x1214a25219492bf7, ; from name: aot-Prova TFG.so
		i64 u0xaeddc246fb716224, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Prova TFG.dll.so
		ptr null; void* handle
	}, ; 67
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x2b8ff66f57e2ac57, ; from name: libaot-Prova TFG
		i64 u0xaeddc246fb716224, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Prova TFG.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x59cdbeaa1d3674a8, ; from name: libaot-Prova TFG.so
		i64 u0xaeddc246fb716224, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Prova TFG.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x78284a184b53be7c, ; from name: Prova TFG.so
		i64 u0xaeddc246fb716224, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Prova TFG.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xa608e60062437d6a, ; from name: Prova TFG
		i64 u0xaeddc246fb716224, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Prova TFG.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xaeddc246fb716224, ; from name: libaot-Prova TFG.dll.so
		i64 u0xaeddc246fb716224, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Prova TFG.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc4a81830198388a2, ; from name: aot-Prova TFG
		i64 u0xaeddc246fb716224, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Prova TFG.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc83cf07e39b83c1c, ; from name: Prova TFG.dll.so
		i64 u0xaeddc246fb716224, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Prova TFG.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xcf9dd5a08ee3a636, ; from name: aot-Prova TFG.dll.so
		i64 u0xaeddc246fb716224, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Prova TFG.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [25 x i8] c"com.companyname.provatfg\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [24 x i8] c"libaot-Prova TFG.dll.so\00", align 16
