...
@aot_dso_cache = dso_local local_unnamed_addr global [774 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x11b6119c3b75c7bd, ; from name: App Master
		i64 u0xe2c3564964a3ce01, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-App Master.dll.so
		ptr null; void* handle
	}, ; 69
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x2269b52313f94abc, ; from name: libaot-App Master.so
		i64 u0xe2c3564964a3ce01, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-App Master.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x40ee3d2902cfdceb, ; from name: App Master.dll.so
		i64 u0xe2c3564964a3ce01, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-App Master.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x6e9c79f0a9035f68, ; from name: aot-App Master
		i64 u0xe2c3564964a3ce01, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-App Master.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x741cfa2f11717899, ; from name: App Master.so
		i64 u0xe2c3564964a3ce01, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-App Master.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x9205965e836146c1, ; from name: aot-App Master.so
		i64 u0xe2c3564964a3ce01, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-App Master.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xad98db25941181e1, ; from name: aot-App Master.dll.so
		i64 u0xe2c3564964a3ce01, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-App Master.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xdd08275b9d043ea4, ; from name: libaot-App Master
		i64 u0xe2c3564964a3ce01, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-App Master.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe2c3564964a3ce01, ; from name: libaot-App Master.dll.so
		i64 u0xe2c3564964a3ce01, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-App Master.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [26 x i8] c"com.companyname.appmaster\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [25 x i8] c"libaot-App Master.dll.so\00", align 16
...
@.DSOCacheEntry.71_name = private unnamed_addr constant [33 x i8] c"libaot-System.Net.Sockets.dll.so\00", align 16
